    ...
    <div class="mt-3">
        ...
        <div class="mb-2 position-relative">
            <form action="../Paginas/pesquisatomates.php">
                <input type="text" class="form-control rounded-3 input-pesquisa ps-5" placeholder="Pesquisar..." value="Tomates">
            </form>
        ...
        <div class="row g-3">
            ...
            <div class="col-6"><a href="../Paginas/produto.php" style="text-decoration: none">
                ...
                favorite
                    ...
                    <div class="card-body m-2 pt-0 pb-2 px-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small class="fw-bolder verde_escuro fs-5">1,00 €</small>
                        </div>
                    </div>
                </div></a>
            </div>
            ...
            <span class="material-symbols-outlined">
                favorite
                    ...
                    <!-- Imagem -->
                    <div class="imagem_card_pesquisa">
                        <img src="../Imagens/produtos/tomates2.jpg" class="card-img-top rounded-4 img_hp_card" alt="Repolho">
                    </div>
                    ...
                    <div class="card-body m-2 pt-0 pb-2 px-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small class="fw-bolder verde_escuro fs-5">3,00 €</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <span class="material-symbols-outlined">
                favorite
                    ...
                    <!-- Imagem -->
                    <div class="imagem_card_pesquisa">
                        <img src="../Imagens/produtos/tomates3.jpg" class="card-img-top rounded-4 img_hp_card" alt="Repolho">
                    </div>
                    ...
                    <div class="card-body m-2 pt-0 pb-2 px-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <small class=" verde_escuro fw-bolder fs-5">
                                <i class="bi bi-star-fill"></i> 4,1
                            </small>
                            <small class="fw-bolder verde_escuro fs-5">2,25 €</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <span class="material-symbols-outlined">
                favorite
                    ...
                    <!-- Imagem -->
                    <div class="imagem_card_pesquisa">
                        <img src="../Imagens/produtos/tomates4.jpg" class="card-img-top rounded-4 img_hp_card" alt="Repolho">
                    </div>
                    ...
                    <div class="card-body m-2 pt-0 pb-2 px-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small class="fw-bolder verde_escuro fs-5">2,80 €</small>
                        </div>
                    </div>
                </div>
            </div>
