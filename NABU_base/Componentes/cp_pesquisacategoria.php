    ...
    <main class="body_index">
        <div class="mt-3">
            ...
            <div class="row g-3">
                ...
                $query= "SELECT anuncios.nome_produto, anuncios.preco, anuncios.id_anuncio FROM anuncios  INNER JOIN categorias ON anuncios.ref_categorias = categorias.id_categorias WHERE categorias.id_categorias= ?";
