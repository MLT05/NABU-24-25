<footer class="footer-menu fixed-bottom verde_bg">
    <div class="d-flex w-100 h-100">
        ...
        <a class="menu-item flex-fill text-center text-white text-decoration-none" href="../paginas/venda.php">
        ...
        <a class="menu-item flex-fill text-center text-white text-decoration-none" href="../paginas/perfil.php">
            <img src="../Imagens/icons/person_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.svg" alt="Perfil" class="menu-icon">
